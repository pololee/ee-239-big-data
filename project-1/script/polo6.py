...
def question_3(url, fw_answer_csv):
	...
	for question in question_list:
		...
		for index in range(len(extracted_user_id_list)):
			...
			fw_answer_csv.write(unicode(line,errors='ignore'))
...
def question_5_helper(fw_user_csv, user_url):
	...
	# fw_user_csv.write(users_line.encode('utf-8', errors="ignore"))
...
def question_5():
	...
	question_5_helper(users_file, "http://www.quora.com/Amardeep-Mangeshkar")
	users_file.close()
...
if __name__ == "__main__":
	...
	## test question 6
	# test_line_number = 5
	# answer_parser(test_line_number)
